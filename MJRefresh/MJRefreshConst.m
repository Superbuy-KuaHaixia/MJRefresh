...
const CGFloat MJRefreshHeaderHeight = 64.0;         // 84.0
const CGFloat MJRefreshFooterHeight = 44.0;
const CGFloat MJRefreshHeaderViewOffsetY = 12.0;    // 32.0
...
NSString *const MJRefreshHeaderBackgroundText = @"MJRefreshHeaderBackgroundText";
